        ...
        <div class="container">
            ...
            <c:if test="${not empty property}">
                <div class="info">
                    ...
                    <p><span class="bold">📅 Check-in Date:</span> ${checkInFormatted}</p>
                    <p><span class="bold">📅 Check-out Date:</span> ${checkOutFormatted}</p>
                    <p><span class="bold">💵 Price per Night:</span> $<fmt:formatNumber value="${pricePerNight}" pattern="#,##0.00"/></p>
                </div>

                <div class="price-box">
                    <p><span class="bold">🧾 Total Price:</span> $<fmt:formatNumber value="${totalPrice}" pattern="#,##0.00"/></p>
            ...
            <c:if test="${empty property}">
                ...
                <a href="${pageContext.request.contextPath}/MainController?action=propertyList" class="back-link">⬅️ Back to Property List</a>
            </c:if>
        </div>
