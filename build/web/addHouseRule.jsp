...
<head>
    <meta charset="UTF-8">
    <title>➕ Add New House Rule</title>
...
<div class="main-content">
    <h2>➕ Add New House Rule</h2>

    <form action="HouseRuleController" method="post">
        <input type="hidden" name="action" value="add">
        <input type="hidden" name="propertyId" value="${propertyId}">
        <input type="text" name="ruleText" placeholder="Enter rule text" required>
        <button type="submit">✔️ Add</button>
    </form>

    <a class="back-link" href="BookingController?action=showBooking&propertyId=${propertyId}">⬅️ Back</a>
</div>
